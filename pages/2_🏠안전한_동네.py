...
st.info(f"**<'안전한 동네' 페이지 분석 목적>**")
st.write("'안전한 자치구'페이지에서 분석과 검증을 통해 범죄 발생과 관련된 중요한 요소(cctv, 유흥주점 비율)를 발견했습니다.")
st.write("해당 페이지에서는 이 요소들을 활용해 본래의 분석 목적인 '2030 여성 1인가구에게 안전한 동네'를 찾아보려고 합니다.")
...
st.info(f"**<한계 및 대안>**")
st.write("분석 목적에 대한 결과 추출 과정에서 어려움이 있었습니다. 분석을 통해 뽑은 안전한 자치구가 1인가구 거주 지역에 속하지 않는다는 문제점을 발견했기 때문입니다.\
    그리하여 1인가구 밀집 자치구도 선정해 추가로 함께 분석하기로 결정하였습니다. ")
st.info(f"**이제 안전한 동네를 찾은 분석 과정에 대한 설명을 시작하겠습니다.**")
