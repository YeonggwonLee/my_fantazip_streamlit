...
st.markdown("이렇게 두 그룹으로 나눠서 안전한 동네 추출 및 특징 파악하고자 합니다.")
...
st.markdown("##### 살기 좋은 동네 찾을 때는, 이것만 기억해주세요!!")
st.warning("- cctv 개수가 적고 유흥업소가 적은 동네")
st.warning("- 도서관이나 공원이 많은 동네")
st.warning("- 유흥업소가 적고 경찰서가 있는 동네")
st.warning("- 아이들이 많고 2030 여성 비율이 높은 동네")
